...
public class SubmitService {
    static public HttpResponse submit(BootpayObject bootpay, String receiptId) throws Exception {
        ...
        if(receiptId == null || receiptId.isEmpty()) throw new Exception("userId 媛믪쓣 �엯�젰�빐二쇱꽭�슂.");

        bootpay.javaApache.model.request.Submit submit = new bootpay.javaApache.model.request.Submit();
