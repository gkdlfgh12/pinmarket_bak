...
import bootpay.javaApache.model.request.Token;
import bootpay.javaApache.model.response.ResToken;
...
public class BootpayObject {
    ...
    public HttpResponse getAccessToken() throws Exception {
        if(this.application_id == null || this.application_id.isEmpty()) throw new Exception("application_id 媛믪씠 鍮꾩뼱�엳�뒿�땲�떎.");
        if(this.private_key == null || this.private_key.isEmpty()) throw new Exception("private_key 媛믪씠 鍮꾩뼱�엳�뒿�땲�떎.");
